...
# 这里写你自己的框架保存地址
sys.path.append('/home/python/Desktop/06spider/aispider')
    ...
    def craw(self, request=aispider.request):
        ...
        for key, value in url_parse_dict.iteritems():
            if value.get('status') == 'active':
                ...
                # 解析方法
                parse_func = value.get('parse_func')
                ...
                for url in website_urls:
                    ...
                    if post_datas:
                        ...
                        put_data = format_put_data(args={"url": url, "method": method, 'data': post_datas,'cookies':cookies,'diy_header':diy_header},
                                                   work_func=request,
                                                   dont_filter=False,
                                                   follow_func=self.get_and_check,
